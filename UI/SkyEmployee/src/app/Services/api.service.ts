...
// Employee
  ...
  updateEmployee(id:string,employee:any):Observable<any>{
    return this.http.put<any>(this.baseApiUrl + 'Employee/Update'+id,employee);
  }
  ...
  updateAddress(id:string,address:any):Observable<any>{
    return this.http.put<any>(this.baseApiUrl + 'EmployeeAddress/UpdateAddress'+id,address);
  }
  ...
  updateFamilyDetails(id:string,familyDetails:any):Observable<any>{
    return this.http.put<any>(this.baseApiUrl + 'FamilyDetails/UpdateFmilyDetail'+id,familyDetails);
  }
